...
const textCertificated =
  `An SSL certificate lets your website ` +
...
const Service = () => (
  <div className="w-full pt-12">
    ...
    <div className="w-10/12 my-0 mx-auto pt-12 pb-10 lg:pt-24">
      <div className="text-center text-xl text-gray-800 font-bold sm:text-xl lg:text-3xl lg:text-left">
        Web Design
      </div>
      <div className="flex">
        <div className="w-full pr-2 lg:w-1/2">
          ...
          <a
            ...
            className="text-green-600 sm:text-lg lg:text-xl xl:text-2xl"
          >
            Read more
          </a>
          <img
            ...
            width="400"
            height="600"
            className="my-0 mx-auto rounded-lg shadow-xl lg:hidden"
          />
        </div>
        ...
        <div className="hidden lg:block lg:w-1/2 lg:relative">
          <img
            src={img_1}
            alt={"imgWebDesign"}
            className="rounded-lg shadow-xl absolute inset-0 h-64 w-full my-auto"
          />
        </div>
      </div>
    </div>
      ...
      <div className="flex">
        <div className="w-full lg:pr-2 lg:w-1/2">
          ...
          <img
            ...
            width="400"
            height="600"
            className="rounded-lg shadow-xl my-0 mx-auto lg:hidden"
          />
        </div>
    ...
    <div className="mt-10 bg-gray-200 py-6 px-10 w-11/12 my-0 mx-auto xl:flex">
      <div className="xl:w-1/3 xl:px-1">
        <div className="font-bold text-gray-800 sm:text-2xl md:text-3xl lg:text-3xl">
          Branding
        </div>
